...
[bug_tracker_opened_issues]: https://framagit.org/rdeville-public/opentofu/openbao-group/issues/?sort=created_date&state=opened&or[label_name][]=Type%3A%3ABug&or[label_name][]=Type%3A%3ARegression&first_page_size=200
...
OpenBao Group, **including completely new features and minor improvements to
...
[issues_page]: https://framagit.org/rdeville-public/opentofu/openbao-group/-/issues
...
- You may want to **include screenshots or screen recordings** which help you
  ...
  instance).
- **Explain why this enhancement would be useful** to most OpenBao Group users. You
...
[new_issues_page]: https://framagit.org/rdeville-public/opentofu/openbao-group/-/issues/new
...
```text
[OpenBao Group] - Join The Project Team
```
...
[README]: https://framagit.org/rdeville-public/opentofu/openbao-group/-/blob/main/README.md
[CODE_OF_CONDUCT]: https://framagit.org/rdeville-public/opentofu/openbao-group/-/blob/main/CODE_OF_CONDUCT.md
[documentation]: https://framagit.org/rdeville-public/opentofu/openbao-group
